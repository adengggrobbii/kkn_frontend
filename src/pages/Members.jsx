...
export const MEMBERS_DATA = [
  {
    ...
    prodi: 'Kalau ga KKN aku gabakal tau gimana rasanya jadi bapak dari 18 princess princess dan gabakal tau rasanya dibangunin tiap pagi',
  ...
  },
  {
    ...
    nama: 'ANGGI SAPUTRA',
    peran: 'Wakil Ketua',
    prodi: 'Kalo ga KKN aku ga bakal ngerasain dateng sendiri pulang berdua',
  ...
  },
  {
    ...
    nama: 'SOFIYANA',
    peran: 'Bendahara',
    prodi: 'Kalo ga KKN aku gabakal ga dapet duit bnyk',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'MARYA TINA',
    peran: 'Bendahara',
    prodi: 'kalo ga KKN gabakal tau gimana rasanya bangun cepet" buat mandi subuh, dan abis itu make up lanjut tidur lagi wkwk',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'NELA ANDANI',
    peran: 'Sekertaris',
    prodi: 'Kalo ga KKN aku gabakal dipanggil mamah kempot',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    peran: 'Sekertaris',
    prodi: 'Kalau ga KKN aku gabakal tau rasanya rebutan kamar mandi + mandi sebelum subuh',
    jurusan: 'S1 GIZI',
  ...
  },
  {
    ...
    peran: 'Sekertaris',
    prodi: 'Kalo ga KKN ga bakal makan tempe setiap hari, ga bakal dipanggil peri kechill, ga bakal jadi pembina upacara wkwkwk, ga bakal mandi jam 4 pagi setiap hari dan ga bakal jadi sopir pick up WHAHAHA',
    jurusan: 'S1 GIZI',
  ...
  },
  {
    ...
    peran: 'Sekertaris',
    prodi: 'Kalo ga KKN aku ga bakal dipanggil mamah sama anak anak dan terkenal menjadi orang have',
    jurusan: 'S1 GIZI',
  ...
  },
  {
    ...
    peran: 'Humas',
    prodi: 'Kalo ga KKN ga akan ngerasain antri mandi berjam jam ga akan ngerasain tiap pagi bangunin adeng dan anggi yang melebihi princess',
  ...
  },
  {
    ...
    nama: 'DINDA TRISNA W',
    peran: 'Humas',
    prodi: 'Kalo ga KKN aku gatau kalo harus cup mandi subuh duluan',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'INDAH NURAINI',
    peran: 'Humas',
    prodi: 'Kalo ga KKN ga bakal bisa dapet pengalaman ngomong di depan banyak orang atau dapet pengalaman bareng masyarakat',
    jurusan: 'S1 KEBIDANAN',
  ...
  },
  {
    ...
    nama: 'FEBY NABILA',
    peran: 'Acara',
    prodi: 'Kalo ga KKN gabakal tau rasanya ditemenin nangis, mandi, beli jajan sama papah adeng sama yaii anggi',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'WINDHU WINDARI',
    peran: 'Acara',
    prodi: 'Kalo ga KKN aku ga bakal tau tempe 1 keping di potong 6 di iris lagi jadi 18',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'SHINTIA',
    peran: 'Acara',
    prodi: 'Kalo ga KKN aku ga akan tau rasanya cinlok sama wakil ketua sendiri di minggu terakhir KKN',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'IMAYASARI',
    peran: 'Perlengkapan',
    prodi: 'Kalau ngga KKN aku ngga bakal ngerasain mandi di gedor gedor',
    jurusan: 'S1 KEPERAWATAN',
  ...
  {
    id: 16,
    nama: 'AINA WAL AZIZAH Z',
    peran: 'Perlengkapan',
    prodi: 'Kalo ga KKN ga bakal ngerasain kena eval terus menerus',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    peran: 'Perlengkapan',
    prodi: 'Kalo ga KKN aku gabakal tau kalo mau mandi harus antri ber jam jam',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    peran: 'Perlengkapan',
    prodi: 'Kalo aku ga KKN aku ga bakal ngerasain bangun jam 4 pagi buat mandi yang pertama',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    nama: 'SUCI RAHMAWATI',
    peran: 'Perlengkapan',
    prodi: 'Kalo ga KKN aku gaakan ngerasain tiap malem di kejar kejar dl up konten, gaakan ngerasain sekamar ber3 with pdd pride ku, gaakan makan berbagai olahan nasi, gaakan ngerasain ketimpa pintu kamar mandi, gaakan ngerasain antre mandi jam 4 subuh, gaakan ngerasain mam mie ayam baso hampir tiap hari, gaakan ngerasain bawa duren sekarung ke posko, gaakan ngerasain bonceng 3, and terakhir gaakan ngerasain CEDERA PINGGUL DI H-12 jam penarikan kkn :(',
    jurusan: 'S1 KEPERAWATAN',
  ...
  },
  {
    ...
    peran: 'Perlengkapan',
    prodi: 'Kalo ga KKN aku ga bakal ngerasain sakit gigi setiap hari + kekurung di kamar mandi gara gara mati lampu',
    jurusan: 'S1 KEPERAWATAN',
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden border border-purple-100 relative">
            ...
            <div className="p-6 space-y-4 text-xs sm:text-sm text-purple-900">
              <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-2xl border border-purple-100">
                ...
                <div>
                  <div className="text-[10px] font-bold text-purple-400 uppercase tracking-wider">Kalo ga KKN?</div>
              ...
              <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-2xl border border-purple-100">
                ...
                <div>
                  <div className="text-[10px] font-bold text-purple-400 uppercase tracking-wider">Jurusan</div>
                  <div className="font-bold text-purple-900"> {selectedMember.jurusan}</div>
                </div>
              </div>
            </div>
          </div>
