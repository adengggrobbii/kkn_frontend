...
export const DEFAULT_INITIAL_COMMENTS = [
  ...
  },
  {
    ...
    role: "Aparatur Desa",
    pesan: "Terima kasih banyak atas dedikasi dan pengabdian seluruh adik-adik mahasiswa KKN di Pekon Ulok Mukti. Program kerja yang dijalankan sangat bermanfaat untuk warga kami.",
  ...
  },
  {
    ...
    pesan: "Senang sekali waktu ada adik-adik KKN yang bantu kegiatan posyandu balita dan lansia di balai pekon. Sukses selalu studinya!",
